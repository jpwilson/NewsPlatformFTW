      ...
      proxy: {
        "/api/admin-articles": {
          ...
          configure: (proxy: any, _options: any) => {
            ...
            proxy.on("error", (err: any, _req: any, _res: any) =>
              console.error("[Vite Proxy Error - /api/admin-articles]:", err)
            );
          },
        },
        "/api/admin-channels": {
          ...
          configure: (proxy: any, _options: any) => {
            ...
            proxy.on("error", (err: any, _req: any, _res: any) =>
              console.error("[Vite Proxy Error - /api/admin-channels]:", err)
            );
          },
        },
        "/api/is-admin": {
          ...
          configure: (proxy: any, _options: any) => {
            ...
            proxy.on("error", (err: any, _req: any, _res: any) =>
              console.error("[Vite Proxy Error - /api/is-admin]:", err)
            );
          },
        },
        "/api": {
          ...
          configure: (proxy: any, _options: any) => {
            proxy.on("proxyReq", (proxyReq: any, req: any, _res: any) =>
              console.log(
                `[Vite Proxy -> localhost:3000] Forwarding: ${req.method} ${req.url}`
              )
            );
            proxy.on("proxyRes", (proxyRes: any, req: any, _res: any) =>
              console.log(
                `[Vite Proxy -> localhost:3000] Response: ${proxyRes.statusCode} for ${req.url}`
              )
            );
            proxy.on("error", (err: any, _req: any, _res: any) =>
        ...
        "/test-prerender": {
          ...
          configure: (proxy: any, _options: any) => {
            proxy.on("proxyReq", (proxyReq: any, req: any, _res: any) =>
              console.log(
                `[Vite Proxy -> localhost:3000] Forwarding test-prerender: ${req.method} ${req.url}`
              )
            );
            proxy.on("proxyRes", (proxyRes: any, req: any, _res: any) =>
              console.log(
            ...
            proxy.on("error", (err: any, _req: any, _res: any) =>
              console.error("[Vite Proxy Error - /test-prerender]:", err)
            );
          },
        },
      },
